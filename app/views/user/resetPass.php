        ...
        <div class="col-sm-8 offset-sm-2 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4 text-center">
            <form class="rounded bg-white shadow py-5 px-4" id="form" spellcheck="false" autocomplete="off">
                ...
                <div class="form-floating">
                    <input type="password" class="form-control" id="cfpassword" placeholder="Password">
                    <label for="password">Nhập lại mật khẩu</label>
                    <small></small>
                </div>
                <button type="submit" class="btn btn-primary submit_btn w-100 my-4 btnResetPass" id="btnSubmit">Đổi mật khẩu</button>
            </form>
        </div>
    </div>
</section>
