<section class="wrapper">
    <div class="container">
        <div class="col-sm-8 offset-sm-2 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4 text-center">
            <form class="rounded bg-white shadow py-5 px-4" id="form" class="login" spellcheck="false" autocomplete="off">
                <div class="logo">
                    <a href="/">
                ...
                <button type="submit" class="btn btn-primary submit_btn w-100 my-4 btnLogin" id="btnSubmit">Đăng nhập</button>
